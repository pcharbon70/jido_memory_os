...
[x] 8.4.1 Task - Migration/cutover integration tests  
Description: Validate dual-run and cutover correctness.
[x] 8.4.1.1 Subtask - Legacy-to-MemoryOS migration test.  
Description: Verify data integrity and retrieval parity.
[x] 8.4.1.2 Subtask - Dual-run drift threshold test.  
Description: Cutover blocked when drift too high.
[x] 8.4.1.3 Subtask - Final cutover test.  
Description: Verify stable operation after switch.

[x] 8.4.2 Task - Rollback/fallback integration tests  
Description: Validate emergency safety mechanisms.
[x] 8.4.2.1 Subtask - Trigger rollback by SLO breach.  
Description: Confirm fast failback behavior.
[x] 8.4.2.2 Subtask - Verify fallback retrieval quality.  
Description: Service remains functional and coherent.
[x] 8.4.2.3 Subtask - Verify post-incident reconciliation.  
